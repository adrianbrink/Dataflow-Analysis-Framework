package main.com.availableexpressions.cfg
...
case class CondW(prv: ProgramPoint, cond: BoolExpression, var tr: ProgramPoint = null, var next: ProgramPoint = null, var list: List[Expression] = List.empty) extends ProgramPoint
case class StatementN(prv: ProgramPoint, stat: Statement, var next: ProgramPoint = null, var list: List[Expression] = List.empty) extends ProgramPoint
case class AssignmentN(prv: ProgramPoint, asgn: Assignment, var next: ProgramPoint = null, var list: List[Expression] = List.empty) extends ProgramPoint
case class CondIf(prv: ProgramPoint, cond: BoolExpression, var tr: ProgramPoint = null, var fl: ProgramPoint = null, var list: List[Expression] = List.empty) extends ProgramPoint
case class ConfluenceIf(iff: ProgramPoint, ls: ProgramPoint, var next: ProgramPoint = null, var list: List[Expression] = List.empty) extends ProgramPoint
